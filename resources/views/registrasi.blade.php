                ...
                <div class="shadow-md shadow-inner max-w-screen-sm w-1/3 mx-auto rounded-[68px] bg-white mt-15 p-12">
                    ...
                    <div class="flex flex-col">
                        <div class="items-center mx-auto">
                            <span class="text-blue-700 items-center font-bold text-4xl italic mb-4">REGISTRASI</span>
                        </div>
                        <div class="mt-10">
                        ...
                        <input type="text" class="border border-slate-300 z-4 py-2 px-4 mt-5 shadow-2xl"
                            placeholder="Email" name="email" />
                        @error('email')
                            <small class="italic text-red-800">{{ $message }}</small>
                        @enderror

                        <input type="password" class="border border-slate-300 z-4 py-2 px-4 mt-5 shadow-2xl"
                        ...
                        @error('nama')
                            <small class="italic text-red-800">{{ $message }}</small>
                        @enderror
                        <input type="date" class="border border-slate-300 z-4 py-2 px-4 mt-5  shadow-2xl"
                        ...
                        <div class="flex flex-col gap-4">
                            <button type="submit" class="bg-blue-800 py-3 mt-10  rounded-full text-white font-bold italic">
                                REGISTRASI
                            </button>
                            ...
                            <p class="text-center">
                                Sudah punya account?
                                <a href="/login" class="text-blue-700">Masuk</a>
                            </p>
                        </div>
                    </div>
                </div>
